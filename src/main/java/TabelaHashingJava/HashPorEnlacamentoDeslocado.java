...
public class HashPorEnlacamentoDeslocado implements HashMethod{
    ...
    public int hash(String chave) {
        ...
        for (int i = 0; i < chave.length(); i++) {
            ...
            hashValue = (leftShift | rightShift) ^ chave.charAt(i);
        }
        return Math.abs(hashValue) % tamanhoTabela;
    }
    @Override
